export const Color = {
  blue: (opacity = 1) => `rgba(95,115,148,${opacity})`,
  lightBlue: (opacity = 1) => `rgba(253,226,200,${opacity})`,
  darkBlue: (opacity = 1) => `rgba(0,70,195,${opacity})`,
  logoBlue: (opacity = 1) => `rgba(95,115,148,${opacity})`,
  ...
  gold: (opacity = 1) => `rgba(171,164,175,${opacity})`,
  logoGreen: (opacity = 1) => `rgba(97,226,101,${opacity})`,
  green: (opacity = 1) => `rgba(189,157,137,${opacity})`,
  ...
  orange: (opacity = 1) => `rgba(112,98,97,${opacity})`,
  pink: (opacity = 1) => `rgba(112,98,97,${opacity})`,
  purple: (opacity = 1) => `rgba(171,164,175,${opacity})`,
  ...
  yellow: (opacity = 1) => `rgba(171,164,175,${opacity})`
};
...
export const phoneMaxWidth = '760px';
